...
with app.app_context():
    ...
    boms_data = [
        ('model_s', 'wheel', 4, 'pieces'),
        ('model_s', 'steering_wheel', 1, 'pieces'),
        ('model_s', 'seat', 4, 'pieces'),
        ('model_s', 'right_mirror', 1, 'pieces'),
        ('model_s', 'left_mirror', 1, 'pieces'),
        ('model_s', 'mid_mirror', 1, 'pieces'),
        ('semi', 'wheel', 8, 'pieces'),
        ('semi', 'steering_wheel', 1, 'pieces'),
        ('semi', 'seat', 1, 'pieces'),
        ('semi', 'big_left_mirror', 1, 'pieces'),
        ('semi', 'big_right_mirror', 1, 'pieces'),
        ('semi', 'lcd_monitor', 2, 'pieces'),
